...
pub fn execute_propose(
    ...
    let sent = match info.funds.len() {
        0 => Err(ContractError::EmptyFunds(cfg.collateral, cfg.denom)),
        1 => {
...
pub fn execute_execute(
    ...
    let msg = CosmosMsg::Bank(BankMsg::Send {
        to_address: prop.creator.to_string(),
        amount: vec![deduct_tax(
            &deps.querier,
            Coin {
                denom: cfg.denom,
                amount: prop.collateral,
            },
        )?],
    });
...
mod tests {
    ...
    fn instantiate_flex(
        ...
        let msg = crate::msg::InstantiateMsg {
            ...
            collateral: Uint128::from(1_000_000_000u128),
        };
    ...
    fn execute_group_changes_from_external() {
        ...
        let (flex_addr, group_addr) = setup_test_case_fixed(
            ...
            required_weight,
            voting_period,
            vec![Coin::new(10, "BTC"), Coin::new(1_000_000_000, "uusd")],
            false,
        );
